...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210427_brigadune7c_da321c22a5a428b58407_20210608223717_archive.zip';
	const ARCHIVE_SIZE		 = '144735421';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'da321c2-08223717';
    const SECONDARY_PACKAGE_HASH = '0930c1b-08223717';
	const VERSION			 = '1.4.0';
